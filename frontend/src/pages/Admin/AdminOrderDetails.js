  ...
  return (
    <AdminLayout>
            <button
              ...
              style={{ background: "transparent", border: "none", color: "var(--clothcore-text-soft)", padding: 0 }}
            ...
            {loading ? (
              ...
              <>
                <div className="admin-page-header">
                  ...
                  <span className="admin-badge admin-badge-info">{order.status}</span>
                </div>
                ...
                <div className="row g-4">
                  <div className="col-lg-7">
                    <div className="card admin-content-card">
                      <div className="card-body">
                        <h5 className="fw-bold mb-3" style={{ color: "var(--clothcore-blush)" }}>Order Information</h5>
                        <div className="row g-3">
                          ...
                          <div className="col-md-6"><small className="text-muted">Total Amount</small><p className="mb-0 fw-medium" style={{ color: "var(--clothcore-blush)" }}>LKR {Number(order.totalAmount || 0).toLocaleString()}</p></div>
                    ...
                    <div className="card admin-content-card mt-4">
                      <div className="card-body">
                        <h5 className="fw-bold mb-3" style={{ color: "var(--clothcore-blush)" }}>Payments</h5>
                        {payments.length === 0 ? (
                          <p className="text-muted mb-0">No payments recorded yet.</p>
                        ) : (
                          <div className="table-responsive">
                            <table className="table admin-table mb-0">
                              <thead><tr><th>Type</th><th>Method</th><th>Amount</th><th>Status</th></tr></thead>
                              <tbody>
                                {payments.map((p) => (
                                  <tr key={p._id}>
                                    <td>{p.paymentType}</td>
                  ...
                  <div className="col-lg-5">
                    <div className="card admin-content-card">
                      <div className="card-body">
                        <h5 className="fw-bold mb-3" style={{ color: "var(--clothcore-blush)" }}>Sample</h5>
                        {sample ? (
                          <>
                    ...
                    <div className="card admin-content-card mt-4">
                      <div className="card-body">
                        <h5 className="fw-bold mb-3" style={{ color: "var(--clothcore-blush)" }}>Delivery</h5>
                        {delivery ? (
                          <>
